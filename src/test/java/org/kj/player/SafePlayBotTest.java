...
public class SafePlayBotTest {
	...
	public void testChancesOfBustWithEmptyHand() {
		SafePlayBot bot = (SafePlayBot) PlayerFactory.getSafePlayBot("bot");
	...
	@Test
	public void testPlayTurnWithProbabilityThresholdZero() {
		SafePlayBot bot = (SafePlayBot) PlayerFactory.getSafePlayBot("bot", 0.0);
		bot.setHand(new ArrayList<Integer>());
		assertTrue(bot.playTurn(0).equals(Action.HIT));
	}
