 ...
 *
 */
class SafePlayBot extends AbstractPlayer {
	 ...
	 */
	SafePlayBot(String name, OutputDevice output) {
		super(name, output);
	...
	/**
	 * Displays only the name and hand size of this SafePlayBot. The cards in the
	 * hand are left hidden.
	 */
	@Override
	public void displayDuringGame() {
		getOutput().displayHandSize(name(), handSize());
	}

	/**
	 * Display's the SafePlayBot's name and hand.
	 */
	@Override
